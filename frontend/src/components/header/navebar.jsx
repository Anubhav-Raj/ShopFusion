      ...
      <header className="snipcss-ECSde">
        <div className="sm-search-header">
          <div className="sm-search-bar">
            <svg className="icon i-menu" viewBox="0 0 24 24" style={{}}>
              <path d="M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z"></path>
            </svg>
            <svg className="icon i-back" viewBox="0 0 24 24" style={{}}>
            ...
            <form autoComplete="off" method="get" action="/products">
              ...
              <svg className="icon i-search" viewBox="0 0 24 24" style={{}}>
                <path d="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z"></path>
              </svg>
            </form>
            <svg className="icon i-vert" viewBox="0 0 24 24" style={{}}>
          ...
          <div className="sm-desktop-header-right">
            <div className="sm-dropdown sm-d-header-user">
              ...
              <span>Login</span>
              <svg className="icon d" viewBox="0 0 24 24" style={{}}>
